...
<p align="center">
  <img src="images/Pipeline Design2.png" alt="VNC-Dist workflow" width="800">
</p>
...
```bash
docker pull ssaha078/vnc_quant_gui:V5
```
2) Launch the GUI from your command prompt:
```bash
docker run -it --rm -p 8501:8501 --name vnc-quant-gui ssaha078/vnc_quant_gui:V5
```
